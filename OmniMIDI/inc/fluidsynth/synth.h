...
extern int
(FLUIDSYNTH_IMP* fluid_synth_program_select_by_sfont_name)(fluid_synth_t *synth, int chan,
...
extern int (FLUIDSYNTH_IMP* fluid_synth_set_portamento_time_mode)(fluid_synth_t *synth, int mode);
extern int (FLUIDSYNTH_IMP* fluid_synth_get_portamento_time_mode)(fluid_synth_t *synth, int *mode);
